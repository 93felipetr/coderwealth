...
- **Executar um teste específico:** `npm test -- <nome-do-arquivo>` ou `pnpm test -- <nome-do-arquivo>`
...
- **Pre-commit hooks:** Executados automaticamente via Husky (se configurado)
